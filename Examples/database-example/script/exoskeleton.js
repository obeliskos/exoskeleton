...
(function (root, factory) {
    ...
    return (function () {
        ...
        function Exoskeleton() {
            ...
            this.events = new ExoEventEmitter(this.exo.file);
         ...
         * @returns {string} the name of the directory in which the exoskeleton executable is located.
         * @memberof File
         */
        ...
        Proc.prototype.start = function (processStartInfo) {
            this.exoProc.Start(JSON.stringify(processStartInfo));
        };
        ...
        Enc.prototype.encryptFiles = function (filemask, password) {
            this.exoEnc.EncryptFiles(filemask, password);
        };
        ...
        Enc.prototype.decryptFiles = function(filemask, password) {
            this.exoEnc.DecryptFiles(filemask, password);
        };
