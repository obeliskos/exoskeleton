...
if exist ..\bin\Debug\Exoskeleton.exe (
  ...
  start ..\bin\Debug\Exoskeleton.exe audioplayer-example\settings.xos
) else (
  if exist ..\bin\Release\Exoskeleton.exe (
    echo Using 'Release' build exoskeleton binary...
    start ..\bin\Release\Exoskeleton.exe audioplayer-example\settings.xos
  ) else (
    echo Using 'Prebuilt' build exoskeleton binary...
    start ..\Prebuilt\Exoskeleton.exe audioplayer-example\settings.xos
  )
)
